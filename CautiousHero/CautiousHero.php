...
<body>
    ...
    <div class="WorkTitle">
        ...
        <?php 
            if(isset($_SESSION['user_id'])){
                ...
                if(isset($_GET['addto'])){ // Ajouter au favori
                    ...
                    // execute the query
                    $stmt->execute();
                    echo "<script type='text/javascript'> document.location = 'CautiousHero.php'; </script>";
                }
            } else {
                echo '<style type="text/css">
                    .favorites-icon{
        ...
        ?>
        <h1 class="oneline">Cautious Hero</h1>
    ...
    <div class="bio">
        <div class="leftSide">
            <br>
            <h1>Cautious Hero</h1>
            <p>Genre : - Fantasy comedy</p>
            <div class="sousgenre">- Isekai</div>

            <br>
            <h1>Manga</h1>
            <p>Written by : Light Tuchihi</p>
            <p>Published by : Fujimi Shobo</p>
            <p>Volumes : 3</p>

            <br>
            <h1>Anime</h1>
            <p>Directed by : - Masayuki Sakoi</p>
            <p>Written by : Kenta Ihara</p>
        ...
        <div class="rightSide">
            ...
            <h1>Presentation</h1>
            <br>
            <p>Cautious Hero: The Hero Is Overpowered but Overly Cautious (Japanese: この勇者が俺TUEEEくせに慎重すぎる, Hepburn: Kono
                Yūsha ga Ore Tsuē Kuse ni Shinchō Sugiru) is a Japanese light novel series written by Light Tuchihi and
                illustrated by Saori Toyota. It began serialization online in June 2016 on the Kadokawa's novel
                publishing website Kakuyomu. It was then acquired by Fujimi Shobo, who published the first light novel
                volume in February 2017 under their Kadokawa Books imprint. Seven volumes have been released as of
                December 2019. The light novel series is licensed in North America by Yen Press.[3] A manga adaptation
                with art by Koyuki has been serialized in Fujimi Shobo's shōnen manga magazine Monthly Dragon Age since
                November 2018. It has been collected in three tankōbon volumes. An anime television series adaptation by
                White Fox aired from October to December 2019. </p>
            <br>
            <h1>Plot</h1>
            <br>
            <p>Ristarte is a novice goddess who is placed in charge of saving the world of Gaeabrande from a Demon Lord
                by summoning a human hero. An S-class world, Gaeabrande is extremely dangerous, so Ristarte is careful
                to select a hero who will be able to prevail against the enemies. She settles on Seiya Ryūgūin, whose
                stats are many times greater than any other contender. Unfortunately, upon summoning him, Ristarte finds
                to her dismay that he is ridiculously cautious of everything, including her. Refusing to even enter
                Gaeabrande's safest areas until he has trained to a level that he is comfortable with, Seiya's reticence
                drives the goddess crazy. However, when the pair finally do set foot on Gaeabrande, events may prove
                this hero's caution is well justified. </p>
            <br>
        </div>
    ...
    <div class="comment">
        ...
        <div class="comment-section">
            <ul class="comment-list">
                <?php
                $sql = "SELECT user_comment_id, comment_id, page_id, username, user_pp, content, date_time  FROM comment WHERE page_id = '10'";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
