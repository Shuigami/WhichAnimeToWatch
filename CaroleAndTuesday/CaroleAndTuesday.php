...
<body>
    ...
    <div class="WorkTitle">
        ...
        <?php 
            if(isset($_SESSION['user_id'])){
                ...
                if(isset($_GET['addto'])){ // Ajouter au favori
                    ...
                    // execute the query
                    $stmt->execute();
                    echo "<script type='text/javascript'> document.location = 'CaroleAndTuesday.php'; </script>";
                }
            } else {
                echo '<style type="text/css">
                    .favorites-icon{
        ...
        ?>
        <h1 class="oneline">Carole & Tuesday</h1>
    ...
    <div class="bio">
        <div class="leftSide">
            ...
            <br>
            <h1>Manga</h1>
            <p>Written by : Morito Yamataka</p>
            ...
            <div class="sousgenre2">- Motonobu Hori</div>
            <p>Written by : Deko Akao</p>
            <div class="sousgenre2">- Motonobu Hori</div>
            <div class="sousgenre2">- Yasuhiro Nakanishi</div>
            <div class="sousgenre2">- Kimiko Ueno</div>
            <div class="sousgenre2">- Yuichi Nomura</div>
            <div class="sousgenre2">- Shinichirō Watanabe</div>
            <div class="sousgenre2">- Keiko Nobumoto</div>
            <p>Studio : Bones</p>
        ...
        <div class="rightSide">
            ...
            <h1>Presentation</h1>
            <br>
            <p>Carole & Tuesday (Japanese: キャロル&チューズデイ, Hepburn: Kyaroru & Chūzudei) is a 24-episode anime television
                series directed by Shinichirō Watanabe. It was animated by studio Bones, in commemoration of the
                studio's 20th anniversary and the 10th anniversary of record label FlyingDog. It aired from April 10 to
                October 2, 2019 on Fuji TV's +Ultra programming block. A manga adaptation by Morito Yamataka began
                serialization in Young Ace in May 2019 and ended in July 2020. The manga is licensed in English by Yen
                Press and is slated for release in 2020. An English dub version premiered worldwide on Netflix on August
                30, 2019. </p>
            <br>
            <h1>Synopsis</h1>
            <br>
            <p>The story takes place about 50 years after humanity began its migration to Mars. It is a time when most
                of the culture is produced by artificial intelligence and humans are content to be passive consumers.
            </p>
            <br>
            <p>Among these people, there are two young women who are very different from the rest of the population:
                Carole, a musician working part-time in the metropolis of Alba, and Tuesday, the daughter of a wealthy
                family from the province of Herschel who dreams of becoming a musician. However, Tuesday's family does
                not understand her dream and she feels very lonely.</p>
            <br>
            <p>One day, these two teenagers meet and decide to change the world of music. They will only be able to
                create a small wave in this society, but this wave could turn into something bigger. </p>
            <br>
        </div>
    ...
    <div class="comment">
        ...
        <div class="comment-section">
            <ul class="comment-list">
                <?php
                $sql = "SELECT user_comment_id, comment_id, page_id, username, user_pp, content, date_time  FROM comment WHERE page_id = '9'";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
