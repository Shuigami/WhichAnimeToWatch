...
<body>
        ...
        <?php 
            if(isset($_SESSION['user_id'])){
                ...
                if(isset($_GET['addto'])){ // Ajouter au favori
                    ...
                    // execute the query
                    $stmt->execute();
                    echo "<script type='text/javascript'> document.location = 'Parasyte.php'; </script>";
                }
            } else {
                echo '<style type="text/css">
                    .favorites-icon{
    ...
    <div class="bio">
        <div class="leftSide">
            <br>
            <h1>Parasyte</h1>
            <p>Genre : - Body horror</p>
            <div class="sousgenre"> - Horror thriller</div>
            <div class="sousgenre"> - Science fiction</div>

            <br>
            <h1>Manga</h1>
            <p>Written by : Hitoshi Iwaaki</p>
            <p>Published by : Kodansha</p>
            <p>Volumes : 10</p>

            <br>
            <h1>Anime</h1>
            <p>Directed by : - Kenichi Shimizu</p>
            <p>Written by : - Shōji Yonemura</p>
            <p>Studio : 25Madhouse</p>
        ...
        <div class="rightSide">
            ...
            <h1>Presentation</h1>
            <br>
            <p>Parasyte (Japanese: 寄生獣, Hepburn: Kiseijū, lit. "Parasitic Beasts") is a Japanese science fiction horror manga series written and illustrated by Hitoshi Iwaaki and published in Kodansha's Morning Open Zōkan and Monthly Afternoon magazine from 1988 to 1995. The manga was published in North America by first Tokyopop, then Del Rey, and finally Kodansha Comics. </p>
            <br>
            <p>The manga has been adapted into two live-action films in Japan in 2014 and 2015 respectively. An anime television series adaptation by Madhouse, titled Parasyte -the maxim-, aired in Japan between October 2014 and March 2015. The English-language dub aired on Adult Swim's Toonami programming block in the United States between October 2015 and April 2016. </p>
            <br>
            <p>Parasyte won the Kodansha Manga Award for the general category in 1993 and the Seiun Award for best manga in 1996. As of December 2020, the manga had over 24 million copies in circulation. </p>
            <br>
            <h1>Plot</h1>
            <br>
            <p>Parasyte centers on a 17-year-old male high school student named Shinichi Izumi, who lives with his mother and father in a quiet neighborhood in Fukuyama, Hiroshima, Japan. One night, tiny worm-like aliens with drill-like heads called Parasites arrive on Earth, taking over the brains of their hosts by entering through their ears or noses. One Parasite attempts to crawl into Shinichi's nose while he sleeps, but fails as Shinichi wakes up, and enters his body by burrowing into his arm instead. In the Japanese version, it takes over his right hand and is named Migi (ミギー), after the Japanese word for 'right'. </p>
            <br>
            <p>Because Shinichi was able to prevent Migi from traveling further up into his brain, both beings retain their separate intellects and personalities. As the duo encounters other Parasites, they capitalize on their strange situation and gradually form a strong bond, working together to survive. This gives them an edge in battling other Parasites who frequently attack the pair upon realization that Shinichi's human brain is still intact. Shinichi feels compelled to fight other Parasites, who devour other members of the species they infect as food, while enlisting Migi's help. </p>
            <br>
            <p>The series explores philosophical questions such as the meaning of humanity, humans' relationship to the environment and other species, the role of instinct and love, and the inherent anthropocentrism of morality. Shinichi's experience with Migi causes him to question if humanity has any right to claim moral superiority to the Parasites, while Migi and Reiko Tamura's experiences with humans cause them to take on more human traits, such as love and sacrifice.</p>
            <br>
        </div>
    ...
    <div class="comment">
        ...
        <div class="comment-section">
            <ul class="comment-list">
                <?php
                $sql = "SELECT user_comment_id, comment_id, page_id, username, user_pp, content, date_time  FROM comment WHERE page_id = '48'";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
