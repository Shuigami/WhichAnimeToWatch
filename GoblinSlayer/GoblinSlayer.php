...
<body>
    ...
    <div class="WorkTitle">
        ...
        <?php 
            if(isset($_SESSION['user_id'])){
                ...
                if(isset($_GET['addto'])){ // Ajouter au favori
                    ...
                    // execute the query
                    $stmt->execute();
                    echo "<script type='text/javascript'> document.location = 'GoblinSlayer.php'; </script>";
                }
            } else {
                echo '<style type="text/css">
                    .favorites-icon{
        ...
        ?>
        <h1 class="oneline">Goblin Slayer</h1>
    ...
    <div class="bio">
        <div class="leftSide">
            ...
            <br>
            <h1>Manga</h1>
            <p>Written by : Kōsuke Kurose</p>
            <p>Published by : Square Enix</p>
            <p>Volumes : 11</p>

            <br>
            <h1>Anime</h1>
            <p>Directed by : - Takaharu Ozaki</p>
            <p>Written by : - Hideyuki Kurata</p>
            <div class="sousgenre2">Yōsuke Kuroda</div>
            <p>Studio : White Fox</p>
            <p>Streaming Website : Wakanim/Crunchyroll</p>
            <p>Episodes : 13</p>
            <br>
        </div>
        ...
        <div class="rightSide">
            ...
            <h1>Presentation</h1>
            <br>
            <p>Goblin Slayer (Japanese: ゴブリンスレイヤー, Hepburn: Goburin Sureiyā) is a Japanese dark fantasy light novel
                series written by Kumo Kagyu and illustrated by Noboru Kannatsuki. A manga adaptation by Kōsuke Kurose
                is serialized in the Monthly Big Gangan magazine, and a second adaptation by Masahiro Ikeno runs in the
                same magazine. A prequel manga by Kento Eida runs in Young Gangan. Both the novels and the manga
                adaptations have been licensed by North American publisher Yen Press. Three audio drama CDs have been
                released, bundled with the fourth, sixth, seventh, and eighth light novels. An anime television series
                adaptation by White Fox aired from October to December 2018. An anime film, titled Goblin Slayer:
                Goblin's Crown, premiered in February 2020. A second season has been announced. </p>
            <br>
            <h1>Plot</h1>
            <br>
            <p>In a world of fantasy, adventurers come from far and wide to join the Guild. They complete contracts to
                earn gold and glory. An inexperienced priestess joins her first adventuring party, but comes into danger
                after her first contract involving goblins goes wrong. As the rest of her party is either wiped out or
                taken out of commission, she is saved by a man known as Goblin Slayer, an adventurer whose only purpose
    ...
    <div class="comment">
        ...
        <div class="comment-section">
            <ul class="comment-list">
                <?php
                $sql = "SELECT user_comment_id, comment_id, page_id, username, user_pp, content, date_time  FROM comment WHERE page_id = '26'";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
